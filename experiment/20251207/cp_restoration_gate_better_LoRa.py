...
# ==============================================================================
def apply_mixed_strategy_lora(model, ffn_ratio=0.25, attn_ratio=0.5):
    """
    智能替换函数：
...
if __name__ == "__main__":
    ...
    model = apply_mixed_strategy_lora(model, ffn_ratio=0.25, attn_ratio=0.8)
    model.cuda()
    # 3. 计算新模型指标
    print("\n[Optimized Model]")
