...
# python src/test.py --model MoCE_IR_S --checkpoint_id /home/aiswjtu/hl/new_image_restoration/20251116_use_headwise_gate_model/MoCE-IR-main/wisegate_checkpoints/2025_11_18_11_38_36 --trainset CDD11_low --benchmarks cdd11 --de_type denoise_15 denoise_25 denoise_50 dehaze derain deblur synllie  --data_file_dir 

#  headwise_gate dim=32 epoch=200
#  PSNR: 26.516822 SSIM: 0.805812 LPIPS: 0.287184

#  headwise_gate dim=48 epoch=120
# PSNR: 26.905598 SSIM: 0.812215 LPIPS: 0.286345
