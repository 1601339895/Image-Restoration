...
def model_S(parser):
    ...
    parser.add_argument('--num_refinement_blocks', nargs="+", type=int, default=4)
    parser.add_argument('--heads', nargs='+', type=int, default=[1, 2, 4, 8])
    parser.add_argument('--ffn_expansion_factor', nargs='+', type=float, default=2.66)
    parser.add_argument('--fusion_type', nargs='+', type=str, default=None,help='FPN,PAFPN,None third slect')
    parser.add_argument('--gate_type',type=str,default='elementwise',help='headwise,elementwise')
    parser.add_argument('--use_frequency_aware',  type=bool, default=True,help='True or False')
    parser.add_argument('--task_aware_fusion',  type=bool, default=True,help='True or False')
...
def model(parser):
    ...
    parser.add_argument('--heads', nargs='+', type=int, default=[1, 2, 4, 8])
    parser.add_argument('--ffn_expansion_factor', nargs='+', type=float, default=2.66)
    parser.add_argument('--fusion_type', nargs='+', type=str, default="PAFPN", help='FPN,PAFPN,None third slect')
    parser.add_argument('--gate_type',type=str,default='elementwise', help='headwise,elementwise')
    parser.add_argument('--use_frequency_aware',  type=bool, default=True, help='True or False')
    parser.add_argument('--task_aware_fusion',  type=bool, default=True, help='True or False')
    return parser
...
def train_options():
    ...
    if base_args.model == "model_S":
        parser = model_S(base_parser())
    elif base_args.model == "model":
        parser = model(base_parser())
    else:
