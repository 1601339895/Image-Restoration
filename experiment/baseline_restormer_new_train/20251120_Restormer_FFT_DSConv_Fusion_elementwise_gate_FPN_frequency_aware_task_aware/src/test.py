...
# python src/test.py --model MoCE_IR_S  --trainset CDD11_low --benchmarks cdd11 --de_type denoise_15 denoise_25 denoise_50 dehaze derain deblur synllie  --data_file_dir 
