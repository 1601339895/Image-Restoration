...
from net.model import Restormer_FFT_DSConv_Fusion
...
class PLTrainModel(pl.LightningModule):
    def __init__(self, opt):
        ...
        self.net =  Restormer_FFT_DSConv_Fusion(
        dim=opt.dim,
        ...
        use_frequency_aware=opt.use_frequency_aware,  # 使用FrequencyAwareBlock
        task_aware_fusion=opt.task_aware_fusion  # 使用任务感知融合
        )
...
#  CUDA_VISIBLE_DEVICES=1,2,3   python src/train.py --model MoCE_IR_S --gate_type elementwise  --batch_size 8 --trainset CDD11_all --num_gpus 2 --de_type denoise_15 denoise_25 denoise_50 dehaze derain --data_file_dir /home/aiswjtu/hl/img_data/Data/ --epochs 200 

# CUDA_VISIBLE_DEVICES=2,3  python src/train.py --model model  --batch_size 8 --trainset CDD11_all --num_gpus 2 --de_type denoise_15 denoise_25 denoise_50 dehaze derain --data_file_dir /home/aiswjtu/hl/img_data/Data/ --epochs 200
