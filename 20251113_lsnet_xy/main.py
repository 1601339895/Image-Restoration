...
import utils
from data_nori.dataloader_nori import get_dirt_dataloader
...
def main(args):
    ...
    if utils.is_main_process() and not args.eval:
        wandb.init(project=args.project, config=args, mode="offline")
    ...
    #     drop_last=True,
    # )
    data_loader_train = get_dirt_dataloader()
    args.nb_classes = 2
    ...
    state_dict = torch.load('/data/workspace/dirt/exp_rep_q/dirt/251106.dirt.LSnet.noridp.glassdata/lsnet_t.pth', map_location='cpu')
    new_state_dict = {}
